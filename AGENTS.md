...
- **Top-level scripts**: frontend uses `dev`, `build`, `start`, `lint` (see frontend/package.json)
...
- [docs/ui-styling.md](docs/ui-styling.md)
...
- [docs/critical-thinking.md](docs/critical-thinking.md)