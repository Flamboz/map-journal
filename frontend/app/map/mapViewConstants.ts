...
export const MARKER_ICON = new Icon({
  iconUrl: assetPath("/leaflet/pin.svg"),
  iconSize: [32, 32],
  iconAnchor: [16, 32],
  popupAnchor: [0, -28],
});
...
export const DRAFT_MARKER_ICON = new Icon({
  iconUrl: assetPath("/leaflet/draft-pin.svg"),
  iconSize: [32, 32],
  iconAnchor: [16, 32],
  popupAnchor: [0, -28],
});
  ...
  return new DivIcon({
    ...
    html: `
      <div style="position:relative;width:32px;height:32px;">
        <img src="${assetPath("/leaflet/pin.svg")}" alt="" style="width:32px;height:32px;display:block;" />
